...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminInfo update(AdminInfo adminInfo) {
        ...
        Admin admin = findAdminById(adminInfo.getId());
        BeanUtils.copyProperties(adminInfo, admin);
    ...
    private Admin findAdminById(Long id) {
        Admin admin = adminRepository.findById(id).orElseThrow(() -> new RbacNotFoundException("账户不存在！"));
        return admin;
    }
}
